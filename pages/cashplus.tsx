...
const CashPlusPage: NextPage = () => {
  const { renderCashPlusForm, pay } = useYouCanPay({
  ...
  return (
    <div className='px-12'>
      <h1 className="text-3xl font-bold underline text-center my-5">
        Payment With YouCan Payment (Only Works on live mode and not Sandbox mode)
      </h1>
